...
def Combine_MOTS_image(rgb_path, MOTS_mask_path):
    ...
    base_colors = {
        1: np.array([0, 0, 255]),   # Blue for cars
        2: np.array([0, 255, 0])    # Green for pedestrians
    }
...
for i in range(154):
    if 0 <= i <= 9:
        rgb_path = 'MOTS_sequence_demo/0000_rgb/00000' + str(i) + '.png'
        gt_path = 'MOTS_sequence_demo/0000_MOTS_mask/00000' + str(i) + '.png'
        labeled_image = Combine_MOTS_image(rgb_path, gt_path)
        cv2.imwrite('MOTS_sequence_demo/0000_MOTS_combined/00000' + str(i) + '.png', cv2.cvtColor(labeled_image, cv2.COLOR_RGB2BGR))
    elif 10 <= i <= 99:
        rgb_path = 'MOTS_sequence_demo/0000_rgb/0000' + str(i) + '.png'
        gt_path = 'MOTS_sequence_demo/0000_MOTS_mask/0000' + str(i) + '.png'
        labeled_image = Combine_MOTS_image(rgb_path, gt_path)
        cv2.imwrite('MOTS_sequence_demo/0000_MOTS_combined/0000' + str(i) + '.png', cv2.cvtColor(labeled_image, cv2.COLOR_RGB2BGR))

    else:
        rgb_path = 'MOTS_sequence_demo/0000_rgb/000' + str(i) + '.png'
        gt_path = 'MOTS_sequence_demo/0000_MOTS_mask/000' + str(i) + '.png'
        labeled_image = Combine_MOTS_image(rgb_path, gt_path)
        cv2.imwrite('MOTS_sequence_demo/0000_MOTS_combined/000' + str(i) + '.png', cv2.cvtColor(labeled_image, cv2.COLOR_RGB2BGR))
